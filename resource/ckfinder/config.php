...
if (($_GET["id"]=="offer_thumb") || ($_GET["id"]=="food_thumb")) {
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => '100000000000000G',
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip,dmg,psd',
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => '2M',
		'allowedExtensions' => 'gif,jpeg,jpg,JPG,JPEG,GIF',
		'deniedExtensions' => 'bmp,psd,BMP,ico,ICO,tiff,TIFF,png,PNG');
...
*/
$config['HtmlExtensions'] = array('html', 'htm', 'xml', 'js', 'php');
