...
- Товары и услуги (Приоритет + ТОР) - рекламодателю (если есть е-меил) , sales@sale-russia.com , support@sale-russia.com
...
if ($offer_type == 'offers') {
				...
				if (($offer_pr_cat == '3') || ($offer_pr_cat == '2')) {
					...
					// Оператор + Саппорт
					$to = "support@sale-russia.com , operator02@sale-russia.com";
				}
